...
# Author  : MrSpace
# GitHub  : https://github.com/uhul23/
# Version : 1.0
...
def spoof():
    ...
    if ("success" in response):
        ...
        psb("\n\033[92m    [\033[91m!\033[92m] Please Try Again After Some Time or Contact with MrSpace!")
        sys.exit("\033[37m")
...
if __name__ == "__main__":
    ...
    print("\033[3;90m                     A Product Of MrSpace\033[0;92m")
    ...
    try:
        ...
        psb("\033[92m    [\033[91m!\033[92m] Please Contact MrSpace or Try Again After Some Time.... \033[37m\n")
        time.sleep(0.8)
        sys.exit()
    main()